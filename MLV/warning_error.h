...
#define ERROR(x) { fprintf( stderr, "Error detected by the function %s() in LibMLV : %s -- line %d, file %s\n", __FUNCTION__, (x), __LINE__, __FILE__ ); exit(1); }
#define PRINT_ERROR(x) { fprintf( stderr, "Error detected by the function %s() in LibMLV : %s -- line %d, file %s\n", __FUNCTION__, (x), __LINE__, __FILE__ ); }

#define WARNING(x) { fprintf( stderr, "Warning generated by the function %s() in LibMLV : %s -- line %d, file %s\n", __FUNCTION__, (x), __LINE__, __FILE__ ); }
